        ...
        {!isLanding && !backendStatus.online && (
          <div style={{
            ...
            <div style={{ lineHeight: '1.5' }}>
              <strong style={{ color: '#fff', fontSize: '14px' }}>Offline Interactive Demo Mode Active:</strong> The cloud portal cannot connect to your local Coral engine. 
              We have loaded a high-fidelity **interactive Demo Mode** so you can search, run SQL queries, and test the AI debug features! 
              To query your live WSL telemetry, launch the local backend by running <code>run_all.bat</code> in the enterprise-agent directory.
            </div>
          </div>
        )}
        {view === 'landing' ? (
